...
As part of this you will prepare a short (7+1 min) presentation of the result that you have duplicated as well as a minimum 2 page writeup in Latex (I very strongly suggest using [Overleaf](https://www.overleaf.com) to do this, you advisor has a paid subscription), following the formatting [I've prepared a helpful example article here](https://www.overleaf.com/read/ccwvxmcmcjtn#6c3693), and which contains all relevant references, background and preliminaries, and a discussion of your research result.
